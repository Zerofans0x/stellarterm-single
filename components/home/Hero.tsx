...
//               className="lg:col-span-4 z-10 pt-1"
//             >
...
//                   <Link
//                     href="/register"
//                     className="px-6 sm:px-7 py-2.5 sm:py-3 bg-[#059669] hover:bg-[#047857] text-white font-medium text-[13.5px] sm:text-base rounded-full shadow-sm hover:shadow-md transition-all inline-flex items-center justify-center cursor-pointer"
//                   >
//                     View Portfolios
//                   </Link>
//                 </motion.div>
...
//                 <button
//                   type="button"
//                   className="inline-flex items-center gap-3 sm:gap-3.5 font-medium group cursor-pointer text-slate-900 hover:text-[#059669] transition-colors duration-200"
//                 >
//                   <span className="w-10 h-10 sm:w-[48px] sm:h-[48px] rounded-full border-[2.5px] sm:border-[3px] border-slate-900 group-hover:border-[#059669] group-hover:scale-105 flex items-center justify-center transition-all duration-200 flex-shrink-0">
//                     <svg
//                       className="w-4 h-4 sm:w-6 sm:h-6 text-slate-900 group-hover:text-[#059669] translate-x-[2px] transition-colors duration-200"
//                       viewBox="0 0 24 24"
//                       fill="none"
//                       stroke="currentColor"
//                       strokeWidth="2.5"
...
//                     </svg>
//                   </span>
//                   <span className="text-[14px] sm:text-[18px] text-slate-900 group-hover:text-[#059669] transition-colors duration-200">
//                     How it works
//                   </span>
//                 </button>
//               </div>
...
//               <div className="mt-14 sm:mt-40 space-y-1.5 sm:space-y-2 text-[9.5px] min-[360px]:text-[11px] sm:text-xs text-slate-600 font-normal sm:font-medium">
...
//             {/* Right Image Column */}
//             <div className="hidden lg:flex lg:col-span-9 relative justify-end items-center ml-40">
//               <div className="relative w-full max-w-[940px]">
//                 <motion.div
//                   animate={{ y: [-3, 4, -3], rotate: [-0.5, 0.5, -0.5] }}
//                   transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut" }}
//                   className="absolute -left-16 top-[178px] xl:-left-[250px] xl:top-[120px] pointer-events-none z-20"
//                 >
//                   <Image

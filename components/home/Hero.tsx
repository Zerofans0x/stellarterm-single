  ...
  return (
    <section className="p-3 sm:p-6 lg:p-8">
      <div className="relative isolate w-full rounded-[24px] sm:rounded-2xl overflow-hidden min-h-[860px] lg:h-[calc(100vh-64px)] flex flex-col justify-between">
        ...
        {/* Background Gradients - Now visible on both mobile and desktop */}
        ...
        <div className="w-full px-4 sm:px-10 lg:px-14 pt-2 pb-10 lg:pt-4 lg:pb-12 flex-1 flex flex-col justify-end lg:justify-center">
          ...
          {/* Replaced 'mt-56' with standard gap spacing for clean stacking on mobile */}
          <div className="grid grid-cols-1 lg:grid-cols-13 items-center lg:items-start px-2 sm:px-8 mt-12 gap-y-12 lg:gap-y-0">
            ...
            >
              <div className="relative">
                <motion.div
                  animate={{ y: [-2, 3, -2], rotate: [-1, 1, -1] }}
                  transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                  className="block lg:hidden absolute right-0 sm:right-6 -bottom-12 pointer-events-none z-20"
                >
                  <Image
                    src="/images/pricing-arrow-mobile.png"
                    alt="Arrow pointing to returns"
              ...
              {/* Package Features List */}
              <div className="mt-10 lg:mt-36 space-y-1.5 sm:space-y-2 text-[9.5px] min-[360px]:text-[11px] sm:text-xs text-slate-600 font-normal sm:font-medium">
                <div className="flex items-center gap-x-2 min-[360px]:gap-x-3 sm:gap-x-5">
                  <span className="flex items-center gap-1 sm:gap-1.5 whitespace-nowrap">
                    <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-[#059669] flex-shrink-0" />
                    Monthly Dividends
            ...
            {/* Right Image Column - Removed 'hidden lg:flex' so it's visible on mobile */}
            <div className="flex lg:col-span-8 relative justify-center lg:justify-end items-center lg:ml-20 w-full mt-6 lg:mt-0">
              <div className="relative w-full max-w-[940px]">
                ...
                <motion.div
                  animate={{ y: [-3, 4, -3], rotate: [-0.5, 0.5, -0.5] }}
                  transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut" }}
                  className="hidden lg:block absolute -left-16 top-[178px] xl:-left-[220px] xl:top-[120px] pointer-events-none z-20"
                >
                  <Image
                    src="/images/pricing-arrow.png"
                    alt="Arrow pointing to dashboard"
                ...
                <div className="relative z-10 w-full">
                  <Image
                    ...
                    height={1164}
                    priority
                    className="w-full lg:w-[800px] h-auto object-contain rounded-[20px] shadow-[0_20px_50px_-15px_rgba(0,0,0,0.1)] border border-slate-100/50"
                  />
                </div>

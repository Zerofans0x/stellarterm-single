...
//         >
//           {/* Desktop Background Image - Original Path Maintained */}
...
//           {/* Mobile Top Illustration - Original Path Maintained */}
...
//               <Link
//                 href="/packages"
//                 className="inline-flex items-center justify-center px-6 py-2.5 text-[14px] sm:text-[15px] font-medium rounded-full transition-colors duration-200 border-[1.5px] border-[#059669] text-[#059669] bg-white sm:border-2 sm:border-slate-900 sm:text-slate-900 sm:hover:border-[#059669] sm:hover:text-[#059669]"
//               >
//                 View portfolios
//               </Link>
//               <Link
//                 href="/register"
//                 className="inline-flex items-center justify-center px-6 py-2.5 text-[14px] sm:text-[15px] font-medium rounded-full transition-colors duration-200 shadow-sm bg-[#059669] text-white hover:bg-[#047857] sm:bg-[#051033] sm:hover:bg-[#059669]"
//               >
//                 Start investing
//               </Link>
//             </div>
